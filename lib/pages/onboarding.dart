...
class _BoardingWidget1 extends StatelessWidget {
  const _BoardingWidget1({
    Key? key,
  }) : super(key: key);
      ...
      child: Column(
        children: [
          SizedBox(
              ...
              child: Image.asset('assets/images/image_first.png')
...
class _BoardingWidget2 extends StatelessWidget {
  const _BoardingWidget2({
    Key? key,
  }) : super(key: key);
...
class _BoardingWidget3 extends StatelessWidget {
  const _BoardingWidget3({
    Key? key,
  }) : super(key: key);
